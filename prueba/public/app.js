...
checkButton.addEventListener('click', async () => {
  ...
  try {
    ...
    lastReport = data; summary.hidden = false; results.hidden = false; emailPanel.hidden = false; message.textContent = 'Consulta completada. No se ha enviado ningún correo.';
  } catch (error) { message.textContent = error.message; }
